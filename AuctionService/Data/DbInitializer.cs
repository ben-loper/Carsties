...
public class DbInitializer
{
    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        context.Auctions.AddRange(GenerateAuctions());

        context.SaveChanges();
    }

    private static List<Auction> GenerateAuctions()
    {
        return
        [
            // 1 Ford GT
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndDate = DateTime.UtcNow.AddDays(10),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                AuctionEndDate = DateTime.UtcNow.AddDays(60),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                AuctionEndDate = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndDate = DateTime.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionEndDate = DateTime.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEndDate = DateTime.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionEndDate = DateTime.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEndDate = DateTime.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
